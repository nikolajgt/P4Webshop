...
{
    public class AdminServiceHealthCheck : IHealthCheck
    {
        private IServiceScopeFactory _scopeFactory;
        private readonly string end_point = "check-adminservice-health";

        public AdminServiceHealthCheck(IServiceScopeFactory scopeFactory)
        {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
        {
            using (var scope = _scopeFactory.CreateScope())
            {
                ...
                if (response == null)
                    return HealthCheckResult.Unhealthy($"Check health failed");
            ...
            return HealthCheckResult.Unhealthy($"The response time is Unhealthy");
        }
    }
}
